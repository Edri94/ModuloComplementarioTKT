...
GuardaSoporte:
        ...
        If IsNumeric(sTicket) Then
            ...
            If dtDatosTicket.Rows.Count > 0 Then
                ...
                If CStr(Val(dtDatosTicket.Rows(0).Item(9))) <> 250 Then
                    ...
                    lsCliente = CStr(dtDatosTicket.Rows(0).Item(4)) & " " &
                                CStr(dtDatosTicket.Rows(0).Item(5)) & " " &
                                CStr(dtDatosTicket.Rows(0).Item(6))
                ...
                End If
            Else
                MsgBox("Ocurrio un error al hacer la consulta a la base de datos", vbCritical + vbInformation, "Busqueda de datos")
                LimpiaCampos()
                If mnTipoOp = 0 Then
                    txTicket.Text = ""
                    txTicket.Focus()
    ...
    Private Sub LlenaCombosCte()
        ...
        If dtListaClientes.Rows.Count <> 0 Then
            sCliente = Trim(dtListaClientes.Rows(0).Item(0))
            If mnTipoOp = 0 Then
                'Es documento de Deposito
