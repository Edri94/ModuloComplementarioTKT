Public Class frmRepOperRelev
    ...
    Private Sub cmdImprimir_Click(sender As Object, e As EventArgs) Handles cmdImprimir.Click
        ...
        ls_PorImprimir = ""
        ls_PorImprimir = " {OPERACION.fecha_captura} > Date (" & fe_Inicio.Substring(0, 4).Trim & "," & fe_Inicio.Substring(5, 2).Trim & "," & fe_Inicio.Substring(8, 2).Trim & ")"
        ls_PorImprimir &= " and {OPERACION.fecha_captura} > Date (" & fe_Fin.Substring(0, 4).Trim & "," & fe_Fin.Substring(5, 2).Trim & "," & fe_Fin.Substring(8, 2).Trim & ")"
