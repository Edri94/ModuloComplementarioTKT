...
Public Class modPermisos
    ...
    '--------------------------------------------------------------------------
    Public Sub ImprimePermisos(Titulo As String, objReporte As ReportDocument)
    ...
    '---------------------------------------------------------------------------
    Public Sub ImprimeBitacora(Usuario As Integer, FechaInicia As String, FechaTermina As String, Titulo As String, objReporte As ReportDocument)
        ...
        Try
            ...
            gs_Sql = gs_Sql & "and BU.aplicacion in (1,9) and "
